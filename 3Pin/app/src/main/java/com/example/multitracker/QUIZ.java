...
public class QUIZ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hasDot = false;
        calculatorIDs = findViewById(R.id.calID);
        calculatorIDs.setBackgroundResource(R.drawable.background_img);
        Window window = QUIZ.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(QUIZ.this,R.color.black));
    ...
    public void fromCalToHome(View view) {
        Intent ins = new Intent(this,Choose.class);
        startActivity(ins);
    }
}
